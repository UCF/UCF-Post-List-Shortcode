...
gulp.task('scss-build-plugin', () => {
  return buildCSS(`${config.src.scssPath}/ucf-post-list.scss`);
});
...
gulp.task('js-build-plugin', () => {
  return buildJS(`${config.src.jsPath}/ucf-post-list.js`, config.dist.jsPath);
});

gulp.task('js-build-plugin-admin', () => {
  return buildJS(`${config.src.jsPath}/ucf-post-list-admin.js`, config.dist.jsPath);
});

// All js-related tasks
gulp.task('js', gulp.series('es-lint-plugin', 'js-build-plugin', 'js-build-plugin-admin'));
